...
from Static_obstacle_avoidance.Method import choose_action, checkPath, \
...
if __name__ == "__main__":
    ...
    # np.savetxt('F:\MasterDegree\毕业设计\FullyCentralizedTD3\data_csv\ actionCurve1List.csv', actionCurve1List, delimiter=',')
    # np.savetxt('F:\MasterDegree\毕业设计\FullyCentralizedTD3\data_csv\ actionCurve2List.csv', actionCurve2List, delimiter=',')
    # np.savetxt('F:\MasterDegree\毕业设计\FullyCentralizedTD3\data_csv\ actionCurve3List.csv', actionCurve3List, delimiter=',')
